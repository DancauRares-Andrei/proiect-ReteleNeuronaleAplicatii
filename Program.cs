...
public class NeuralNetwork
{
    ...
    private double learningRate = 0.71; 
    private double maxError = 0.01; 

    public NeuralNetwork()
    {
        inputToHiddenWeights = new double[4, 3]
        {
            { 0.17, 0.08, -0.76 },
            { 0.32, 0.99, 0.43 },
            { 0.22, 0.98, 0.94 },
        ...
        hiddenToOutputWeights = new double[3, 2]
        {
            { 0.21, 0.29 },
            { 0.29, 0.66 },
            { -0.44, -0.48 }
        ...
        hiddenLayerOutputs = new double[3];
        outputLayerOutputs = new double[2];

        hiddenLayerErrors = new double[3];
        outputLayerErrors = new double[2];
    }
